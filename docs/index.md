...
description: An interactive intelligent textbook with MicroSims to teach high-school students about 3D printing, designed to maximize the probability of college credit.
image: img/cover.png
...
- **[Chapters](chapters/index.md)** — the main educational content, 16 chapters in sequence
- **[MicroSims](sims/index.md)** — hands-on interactive simulations for every major concept
- **[Learning Graph](learning-graph/index.md)** — see how concepts connect and depend on each other
- **[Glossary](glossary.md)** — definitions for every technical term, in plain language
- **[FAQ](faq.md)** — answers to the questions students ask most often

## Getting Started

Begin with [Chapter 1: Foundations and History of Additive Manufacturing](chapters/01-foundations-and-history/index.md) to build the context you'll need for everything that follows. Your guide throughout the book is **Benchy** — an anthropomorphic 3DBenchy tugboat who has been printed badly more times than he'd like to admit, and learned something from every one of them.
