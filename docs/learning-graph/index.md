# Learning Graph for Introduction to 3D Printing
...
[3D Printing Organizations](./3d-printing-orgs.md) — survey of the standards bodies, industry groups, and articulation pathways that frame this course (PLTW, ASTM, America Makes, SME, NC3, NIMS, ABET, community colleges).
...
We use generative AI to convert the course description into a [Concept List](./concept-list.md). Each concept is in the form of a short Title Case label with most labels under 32 characters long. This course has **292 concepts**.
...
[View the Course Description Quality Assessment](./course-description-assessment.md) — score: **100/100**
...
- Graph structure validation — all concepts are connected (1 component, 0 orphans)
- DAG validation (no cycles detected)
- Foundational concepts: 12 entry points
- Indegree distribution analysis
- Longest dependency chain: 14 hops
...
- 16 categories spanning foundations, history, standards, processes, design, CAD, files, slicing, hardware, materials, resin, DfAM, troubleshooting, safety, workflows/careers, and AI in additive manufacturing
- Category organization — foundational elements first, course capstone project ideas last
- Balanced categories (2.7 % – 17.8 % each)
