...
|---|---------|-------|--------|-------|
| 1 | Concepts | 292 | Required | Concepts from learning graph |
...
| 7 | Glossary Terms | 292 | Recommended | Defined terms in glossary.md |
| 8 | FAQs | 81 | Recommended | Questions in faq.md |
| 9 | Words | 169,061 | Required | Words across student-facing markdown |
| 10 | Mascot | 13 | Optional | Mascot image poses in docs/img/mascot/ |
...
|-------------|-------------|---------------|-------|
| Diagrams | 50 | 45 | H4 headers starting with '#### Diagram:' |
| Equations | 2 | 1 | LaTeX expressions (inline and display) |
| Total Words | 169,061 | 114,495 | Words in markdown files |
| Links | 483 | 206 | Hyperlinks in markdown format |
| Equivalent Pages | 711 | 492 | Estimated pages (250 words/page + visuals) |
