...
| Concepts | 292 | [Concept List](./concept-list.md) | Concepts from learning graph |
...
| Total Words | 91,842 | 82,057 | Words in markdown files |
| Links | 85 | 58 | Hyperlinks in markdown format |
| Equivalent Pages | 380 | 339 | Estimated pages (250 words/page + visuals) |
